...
The most user-friendly way to run the GUI is via Docker. If you would like to run it without using this tool, you might find more information about this process in the MAL-Sim-GUI dedicated repository: [Link to Repo](https://github.com/mal-lang/malsim-gui)
...
<img width="1920" height="880" alt="MALSIM_GUI_1" src="https://github.com/user-attachments/assets/70c7ef9d-0075-4cea-ba3b-c6da4ab9977c" />
